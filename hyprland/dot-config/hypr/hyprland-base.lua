...
hl.monitor({ output = "DP-2", mode = "2560x1440@170", position = "0x0", scale = 1 })
hl.monitor({ output = "DP-3", mode = "1920x1080@60", position = "-1920x300", scale = 1 })
hl.monitor({ output = "HDMI-A-1", mode = "3840x2160@120", position = "2560x0", scale = 1 })
-- Default
...
local noctalia = "noctalia msg" -- Prefix for noctalia keybinds
...
-- Move active workspace to another adjacent monitor
...
hl.bind(mainMod .. " + SHIFT + grave", hl.dsp.workspace.swap_monitors({ monitor1 = "current", monitor2 = "+1" }))
